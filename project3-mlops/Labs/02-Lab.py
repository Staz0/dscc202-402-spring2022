...
with mlflow.start_run(run_name= "RF_Grid_Search") as run:
    ...
    # Log model with name
    grid_random_forest_model = mlflow.sklearn.log_model(rf, "random-forest-model")
  
    # Log params
    log_params = mlflow.log_params(parameters)
  
    # Create and log MSE metrics using predictions of X_test and its actual value y_test
    mse = mean_squared_error(y_test, predictions)
    log_mse = mlflow.log_metrics({"mse": mse})
...
# TODO
artifactURI = 'runs:/'+runID+"/random-forest-model"
